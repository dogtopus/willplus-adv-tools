...
module O2RSettings
    ...
    FLAG_TABLE = {
        ...
        819 => ['has_bg', Flag::HINT, FlagCategory::SYSTEM],
        ...
        856 => ['option_group', Flag::INCLUDE, FlagCategory::SYSTEM],
        911 => ['has_bgm', Flag::HINT, FlagCategory::SYSTEM],
        920 => ['current_replay_id', Flag::INCLUDE, FlagCategory::SYSTEM],
        ...
        1005 => ['seen_disclaimer', Flag::INCLUDE, FlagCategory::SYSTEM],
        1600 => ['unlock_replay_a0', Flag::INCLUDE, FlagCategory::UNLOCK],
        2999 => ['first_run', Flag::INCLUDE, FlagCategory::SYSTEM],
