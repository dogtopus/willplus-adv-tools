...
module O2RSettings
    ...
    FLAG_TABLE = {
        ...
        7 => ['is_blue_r0', Flag::INCLUDE, FlagCategory::STORY],
        43 => ['asked_roddy_for_dinner', Flag::INCLUDE, FlagCategory::STORY],
        47 => ['met_ioan_r0_d4_am', Flag::INCLUDE, FlagCategory::STORY],
        48 => ['found_book_r0_d4_noon', Flag::INCLUDE, FlagCategory::STORY],
        170 => ['aff_roddy', Flag::INCLUDE, FlagCategory::STORY], # As of Route0
        171 => ['aff_ioan', Flag::INCLUDE, FlagCategory::STORY], # As of Route0
        172 => ['aff_greg', Flag::INCLUDE, FlagCategory::STORY],
        174 => ['aff_dag', Flag::INCLUDE, FlagCategory::STORY],
        180 => ['gem_37564', Flag::INCLUDE, FlagCategory::STORY], # As of Route0
        181 => ['house', Flag::INCLUDE, FlagCategory::STORY], # As of Route0
        ...
        211 => ['disp_list', Flag::INCLUDE, FlagCategory::SYSTEM], # As of Route0
        ...
        850 => ['has_opt_0', Flag::HINT, FlagCategory::SYSTEM],
        851 => ['has_opt_1', Flag::HINT, FlagCategory::SYSTEM],
        852 => ['has_opt_2', Flag::HINT, FlagCategory::SYSTEM],
